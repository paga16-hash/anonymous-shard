...
class TCPSOCKS implements Transport<TCPDialEvents> {
    ...
    constructor (components: TCPComponents, options: TCPOptions = {}, socksProxy: string = 'socks5h://tor2:9050') {
        this.log = components.logger.forComponent('libp2p:socks-tcp')
        this.opts = options
    ...
    readonly [Symbol.toStringTag] = '@libp2p/socks-tcp'
