...
<template>
  <div class="tasks">
    <button @click="simulateSubmit" style="margin-left: 10px">Simulate submit</button>
    <button @click="getTasks" style="margin-left: 10px">Refresh</button>
    <task-badge v-for="(task, index) in tasks" :key="index" :task="task" />
  </div>
</template>
